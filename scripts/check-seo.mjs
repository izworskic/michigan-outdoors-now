...
assert.match(home, /Michigan is big\. Pick a pull\./);
assert.match(home, /Choose your adventure/);
assert.match(home, /Keep it close/);
assert.match(home, /Find water/);
assert.match(home, /Head north/);
assert.match(home, /Disappear for a while/);
assert.match(home, /Chase sunset/);
assert.match(home, /Make it a big day/);
assert.match(home, /Make a weekend of it/);
assert.match(home, /Surprise me/);
assert.match(home, /Starting from/);
