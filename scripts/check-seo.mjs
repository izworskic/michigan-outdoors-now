...
assert.match(home, /Find somewhere worth going\./);
assert.match(home, />Today</);
assert.match(home, />This weekend</);
assert.match(home, />Check a place</);
assert.match(home, />Pick an activity</);
assert.match(home, /Where are you starting\?/);
