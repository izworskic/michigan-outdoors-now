...
replace_once(
    "src/app/api/discover/route.ts",
    'authoritative Michigan DNR, U.S. Forest Service, National Park Service, U.S. Fish & Wildlife Service, and USGS PAD-US open-access protected-land inventories. OpenStreetMap enrichment',
    'authoritative Michigan DNR, U.S. Forest Service, National Park Service, U.S. Fish & Wildlife Service, USGS PAD-US open-access protected-land inventories, plus direct Huron-Clinton Metroparks, Oakland County and Kent County GIS. OpenStreetMap enrichment',
)
